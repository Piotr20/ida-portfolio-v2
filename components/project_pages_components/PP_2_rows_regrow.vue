<template>
  <section id="2-rows-grid">
    ...
    <div class="grid-container">
      <div class="cell-1">
        <p>
          RePot skal være et brand der har en meget direkte kommunikation, der
          er seriøs, dramatisk og kraftfuld. Skaberne bag RePot har udtalt at de
          ikke var blege for at være netop dette.
          <br /><br />
    ...
    <div class="grid-container">
      ...
      <div class="cell-8">
        <img
          src="../../static/images/regrow/regrow-pot.png"
          alt="Regrow pot illu."
        />
        <img
          src="../../static/images/regrow/repot-plant.png"
          alt="Regrow pot illu."
        />
      </div>
    </div>
